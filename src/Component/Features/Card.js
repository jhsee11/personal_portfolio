...
const Card = (props) => {
  ...
  return (
    <div
      className="w-[410px] h-[320px] ml-0 p-6 bg-turquoise text-black overflow-hidden rounded-md cursor-pointer ease-in duration-200 hover:scale-[1.01] hover:rounded-2xl 
